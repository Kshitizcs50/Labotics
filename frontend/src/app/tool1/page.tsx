...
const labs: Lab[] = [
  ...
  { id: 3, name: "Metro Patholog", location: "Bangalore", price: 1500, tests: ["MRI", "CT Scan", "Blood"] },
  { id: 4, name: "Wellness Labs", location: "Chennai", price: 1000, tests: ["Blood", "Lipid", "Diabetes"] },
];
